...
- **NEW:** Instant card deposits (Visa/Mastercard) – fund in 60 seconds
...
### 🆕 NEW: Instant Card Deposits (January 2025)

GatesFX now accepts **Visa and Mastercard deposits** – both credit and debit cards! This is a game-changer for traders who want to fund quickly:

| Feature | Details |
|---------|---------|
| **Processing Time** | Under 60 seconds (most deposits) |
| **Minimum Deposit** | $25 |
| **Maximum Deposit** | $5,000 per transaction |
| **Supported Cards** | Visa, Mastercard (Credit & Debit) |

[Read our full article on GatesFX card deposits →](/blog/gatesfx-card-deposits-2025)

### All Deposit Methods

- **Credit/Debit Card:** $25-$5,000, instant (under 60 seconds) ⭐ NEW
