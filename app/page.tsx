...
export default async function HomePage() {
  ...
  const { data: brokers, error } = await supabase
    .from("brokers")
    .select(
      "id, name, logo, description, tags, asset_types, min_deposit, deposit_fee, withdrawal_fee, inactivity_fee, leverage, regulation, country_established, country_code, year_established, affiliate_link, is_featured, youtube_url",
    )
